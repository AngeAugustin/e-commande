...
export function CopyOrderCodeButton({ code }: CopyOrderCodeButtonProps) {
  ...
  return (
    <button
      ...
      className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-palm/20 text-palm transition hover:border-palm/40 hover:bg-palm/5"
    >
      {copied ? (
        <svg
          aria-hidden="true"
